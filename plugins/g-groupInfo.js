let handler = async (m, { conn, usedPrefix, participants, groupMetadata, text }) => {
    ...
    try {
        ...
        let { isBanned, welcome, detect, sWelcome, sBye, sPromote, sDemote, antiLink, antiBuleAll, antiVirus, expired, descUpdate, stiker, antispam, antitroli, antivirtex, antiBadword, simi, closeGroup } = global.db.data.chats[m.chat]
